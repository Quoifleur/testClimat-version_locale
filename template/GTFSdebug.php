...
if ($fichierChargé) {
    echo 'Temps d\'exécution GTFcsvTOmap : ' . ($execution_time_GTFcsvTOmap / 1e9) . ' secondes <br/>
   Temps d\'exécution Explicite : ' . ($execution_time_fichierExplicite / 1e9) . ' secondes <br/>
    ...
    echo 'Fichier non chargé, pas de temps d\'exécution à afficher.';
}

echo '<h2>Notification(s)</h2>';
